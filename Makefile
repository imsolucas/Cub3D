...
BONUS_FILES	= main_bonus.c \
			  $(addprefix $(PARSE_DIR), parse.c parse_validate.c parse_process.c ft_split_whitespace.c parse_map_bonus.c parse_utils.c parse_utils2.c validate_map.c validate_map_flood.c validate_map_utils.c) \
			  $(addprefix $(GNL_DIR), get_next_line.c) \
